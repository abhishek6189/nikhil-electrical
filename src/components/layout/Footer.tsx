    ...
    <footer className="cta-section text-primary-foreground">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <div className="badge-primary bg-primary/20 text-primary-foreground border-primary-foreground/20 mb-4 inline-flex items-center gap-2">
            <span className="w-2 h-2 bg-primary-foreground rounded-full"></span>
            Certified
          </div>

          <h2 className="text-lg font-semibold text-primary-foreground/80 mb-2">
            Government Approved
          </h2>
